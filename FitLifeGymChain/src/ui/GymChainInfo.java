...
public class GymChainInfo {
    ...
    public static final String YOUR_GYM_NAME = "Toronto";
    public static final String MOHAMED_MEMBER_NAME = "Mohamed";
    ...
    private static void loadMembers(GymChain chain){
        ...
        Member m4 = new Member(MOHAMED_MEMBER_NAME);
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym Toronto = new Gym(YOUR_GYM_NAME);

        initializeGym0(Toronto);

        chain.addGym(Toronto);
    }


    private static void initializeGym0(Gym gym){

         Barbell bar = new Barbell(100);
